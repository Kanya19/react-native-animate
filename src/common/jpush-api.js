...
export default class JPush {
  ...
  static addConnectEventListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(ConnectEvent, (result) => {
      callback(result)
    })
  }
  ...
  static addNotificationListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(NotificationEvent, (result) => {
      callback(result)
    })
  }
  ...
  static addLocalNotificationListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(LocalNotificationEvent, (result) => {
      callback(result)
    })
  }
  ...
  static addCustomMessageListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(CustomMessageEvent, (result) => {
      callback(result)
    })
  }
  ...
  static addTagAliasListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(TagAliasEvent, (result) => {
      callback(result)
    })
  }
  ...
  static addMobileNumberListener(callback) {
    listeners[callback] = DeviceEventEmitter.addListener(MobileNumberEvent, (message) => {
      callback(message)
    })
  }

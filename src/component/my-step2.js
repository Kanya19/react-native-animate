...
class MyStep extends React.Component {
  // template
  render() {
    const {list, stepBox, stepItem, active, disColor, activeColor} = this.props
    ...
    <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="checked" transform="translate(0.875000, 0.875000)" fill=${
              activeColor || '#FF4563'
            } fill-rule="nonzero">
    ...
    return (
      <View style={{height: 50, marginTop: 10, paddingTop: 80}}>
                ...
                <View key={key} style={styles.listItem}>
                  {!!item.label && (
                    <View style={{position: 'absolute', top: -40}}>
                      <Text style={{textAlign: 'center', fontSize: 16, color: active > key ? '#999999' : '#333333'}}>
                        {item.label}
                      </Text>
                    </View>
                  )}
                  ...
                  {key === active - 1 ? (
                    ...
                    <View
                      style={{
                        ...
                        borderColor: '#fff',
                        borderRadius: 6,
                        backgroundColor: key < active ? activeColor || '#FF4563' : disColor || '#E6E6E6',
                      }}
                    />
                  )}

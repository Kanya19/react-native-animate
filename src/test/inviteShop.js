...
class Invite extends React.Component {
  ...
  getDetail() {
    api
      .getBanner({
        scene: BannerSceneEnum.SHOP_SHARE,
      })
      .then((res) => {
        console.log('res', res)
        res = res || []
    ...
    api.getShopInviteQrcode().then((res) => {
      if (res) {
        this.setState({
  ...
  onShareAppMessage = () => {
    ...
    const tenantId = this.props.user.detail.tenantId
    let handlePath = '/pages/mine/applyShop?tenantId=' + tenantId
